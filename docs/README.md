...
| MOSFETs | 6x N-channel (high/low per phase) |
| Hall Sensors | 3x digital (PB6, PB7, PB8) |
...
- **Software dead-time:** Not implemented. Theoretical shoot-through risk during MOSFET switching.
...
- **Dead-time:** Software dead-time is not implemented. Test on bench with current-limited power supply before connecting to a vehicle.
...
| [ROADMAP.md](ROADMAP.md) | 7-phase development plan with tasks, risks, test items |
