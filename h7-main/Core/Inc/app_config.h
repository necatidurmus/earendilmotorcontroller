 ...
 *  These must match the F411 motor controller's accepted ranges so that
 *  the H7 rejects out-of-range values before forwarding them. */
#define H7_RPM_MAX_ROVER         200U    /* Rover motion commands: safe limit */
#define H7_RPM_MAX_RAW           500U    /* Raw motor RPM: matches F411 MAX_RPM_TARGET */
#define H7_DUTY_MAX              4000U   /* Matches F411 PWM_MAX_DUTY */
#define H7_KICKMS_MAX            1000U   /* Matches F411 KICK_MS_MAX */
#define H7_BOOST_MS_MAX          1000U   /* Matches F411 (boost 8-pwm ms) */
#define H7_TELPER_MIN            20U     /* Matches F411 practical min */
#define H7_TELPER_MAX            5000U   /* Matches F411 practical max */
