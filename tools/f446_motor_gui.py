...
class App(tk.Tk):
    ...
    def _do_identify(self):
        ...
        if not messagebox.askyesno(
            ...
            return
        # Auto-unlock bridge service, then send identify
        self._send("bridge unlock_service CURRENT_LIMITED_BENCH_SUPPLY")
        self.after(200, lambda: self._send("m1 identify"))
    ...
    def _send_raw_to_f411(self):
        ...
        if raw:
            ...
            dangerous = ['gatetest', 'identify', 'test', 'scan', 'base', 'boost',
                        'pi', 'kp', 'ki', 'kick on', 'ramp off', 'defpwm',
